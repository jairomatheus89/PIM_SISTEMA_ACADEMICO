...
def mostrar_atividades(self):
    ...
    Button(botoes_interno, text="Editar Atividade", command=lambda: editar_atividade_tree(self)).grid(row=0, column=1, padx=5)
    Button(botoes_interno, text="Excluir Atividade", command=lambda: excluir_atividade_tree(self)).grid(row=0, column=2, padx=5)
