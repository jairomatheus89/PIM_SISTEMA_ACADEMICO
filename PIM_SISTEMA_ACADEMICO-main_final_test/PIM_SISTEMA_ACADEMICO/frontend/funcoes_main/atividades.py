...
def mostrar_atividades(self):
    ...
    Button(botoes_interno, text="Criar Atividade", bg=BTN_COLOR, fg=BTN_TEXT_COLOR,command=lambda: criar_atividade_widgets(self)).grid(row=0, column=0, padx=5)
    Button(botoes_interno, text="Editar Atividade", bg=BTN_COLOR, fg=BTN_TEXT_COLOR, command=lambda: editar_atividade_tree(self)).grid(row=0, column=1, padx=5)
    Button(botoes_interno, text="Excluir Atividade", bg=BTN_COLOR, fg=BTN_TEXT_COLOR, command=lambda: excluir_atividade_tree(self)).grid(row=0, column=2, padx=5)
...
def criar_atividade_widgets(self):
    ...
    self.form_atividade_frame = Frame(self.frames["atividades"], bg=BG_COLOR)
    self.form_atividade_frame.config(bg=BG_COLOR)
    ...
    Button(self.form_atividade_frame, text="CRIAR ATIVIDADE", command=lambda: criar_atividade(self)).pack(pady=10)
...
def editar_atividade_tree(self):
    ...
    # Reaproveita o layout de criação, mas remove o campo de turma
    criar_atividade_widgets(self)

    # Esconde campo de turma (não pode ser alterado)
