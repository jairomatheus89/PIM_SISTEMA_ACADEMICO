...
class TelaLogin:
    def __init__(self, master=None):
        ...
        self.login_button = Button(self.frame_login_professor, text="Logar", width=30, bg="#D4A017", fg="#0D1B2A", font=("Arial", 12, "bold"), activebackground="#e6b800", command=self.login_professor)
        self.login_button.grid(row=3, column=0, columnspan=2, pady=5, ipady=5)

        # Botão Voltar
        self.voltar_professor = Button(self.frame_login_professor, text="Voltar", width=30, bg="#CCCCCC", fg="#0D1B2A",font=("Arial", 12, "bold"), activebackground="#b3b3b3", command=self.voltar_escolha)
